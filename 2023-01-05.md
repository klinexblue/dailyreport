...
![/etc/hosts in nt kernel](./images/etchosts_cut.png){: width="70%"}
...
![Apache 가상 호스트](./images/apache_virtual_hosts_cut.png){: width="70%"}
...
![Nginx 구동 성공 사례](./images/nginx_success.png){: width="70%"}
