...
그러나, **위 에러 문장이 계속해서 나오고 있다**. 현재 솔루션을 다시 찾는 중이다.  
버전은 최신버전이 아닌 과거 버전으로 설치하여도 마찬가지 상태.  
...
mysql 디렉터리 하위에 mysql 그룹 및 계정 소유의 디렉터리 mysql-files 를 생성시킨다.
...
>>>>>>> fd96fede70fcc374f059e2cfcef06fc9fb5fc581
